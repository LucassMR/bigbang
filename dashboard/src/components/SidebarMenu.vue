        ...
        <li>
          <router-link to="/">
            <Transition name="fade">
              <span v-show="isSidebarOpen">Painel</span>
            </Transition>
          </router-link>
        </li>
        <li>
          <router-link to="/about">
            <Transition name="fade">
              <span v-show="isSidebarOpen">Projetos</span>
            </Transition>
          </router-link>
        </li>
        <li>
          <router-link to="/team">
            <Transition name="fade">
              <span v-show="isSidebarOpen">Leads</span>
            </Transition>
          </router-link>
        </li>
        <li>
          <router-link to="/contact">
            <Transition name="fade">
              <span v-show="isSidebarOpen">Notificação</span>
            </Transition>
          </router-link>
        </li>
      </ul>
